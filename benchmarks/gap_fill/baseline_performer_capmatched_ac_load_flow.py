...
RESULTS_DIR = HERE.parent / "results" / "gap_fill" / "baseline_performer_capmatched_ac_load_flow"
...
SIZE_CONFIGS = (
    SizeConfig(name="Small", n_breakpoints=20, latent_dim=8, hidden_sizes=(35,), n_steps=10, n_epochs=15),
)
...
def build_performer_gnn(config: SizeConfig, in_structure, out_structure, *, seed: int) -> GNN:
    ...
    Identical to :func:`baseline_performer_linearsystem.build_performer_gnn`; kept
...
def write_partial(all_runs: list[RunResult], status: str) -> Path:
    ...
    out_path = RESULTS_DIR / "baseline_performer_ac_load_flow.json"
